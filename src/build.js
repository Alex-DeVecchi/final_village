class Building {
    ...
    buttonState(){
        ...
        document.getElementById(this.buttonId).innerHTML = "Buy " + this.buildingName + " (Cost: $" + Math.ceil(this.cost).toLocaleString() + 
        ")<br> Adds $" + (this.baseCps * 1000 / tickRate()).toLocaleString() + "Per Second <br> [Owned: "
        + this.amountOwned + "]";
    }
}